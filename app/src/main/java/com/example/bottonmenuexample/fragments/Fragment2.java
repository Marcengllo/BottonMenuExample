...
public class Fragment2 extends Fragment implements adapterbangun.ItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        balok.setImageBangun("https://akcdn.detik.net.id/visual/2023/02/24/ilustrasi-bangun-ruang-balok_169.jpeg?w=650");
        listDataBangunDatar.add(balok);

        modelbangun silinder = new modelbangun();
        silinder.setNamaBangunn("Silinder");
        silinder.setImageBangun("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQqbwPpQaDtrNl4pWekoGX95QwinnsQQmmdKl95fqb2yq3iN9_cRV2wbFYUmoRDnW-oLk&usqp=CAU");
